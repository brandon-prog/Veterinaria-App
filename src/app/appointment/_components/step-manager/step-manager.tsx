...
export default function StepManager({ 
  ...
  }, [petType, petName, petGender, petBreed, petDescription, petsCount, setStep1Valid]);
  ...
  }, [serviceType, visitReason, setStep2Valid]);
  ...
  }, [serviceType, expanded, getValues, setValue, setExpanded]);

  useEffect(() => {
    setStep3Valid(!!appointmentDate && !!appointmentTime && termsAccepted);
  }, [appointmentDate, appointmentTime, termsAccepted, setStep3Valid]);
